			...
			<div style="display:flex;padding:20px;">
				...
				<visualForm_1.default onSubmit={onSubmit.bind(this)} style="flex-grow:1">
					...
					<div>
						...
						<input style="width:50px;" type="number" id="boxCount" name="boxCount" value={boxCount} onInput={(e) => {
            if (e.target.value < 1)
                return;
            ...
            if (e.target.value > boxes.length) {
                ...
                setBoxes([...boxes.slice(0, e.target.value)]);
					...
					<div>
						...
						<input style="width:50px;" type="number" id="frameCount" name="frameCount" value={frameCount} onInput={(e) => setFrameCount(e.target.value)} min="0" max="40" steo="1"/>
					</div>
