...
exports.default = ({ hiveId, frames, boxes, apiaryId, boxSelected, frameSelected = 0, frameSide, editable = true, onBoxClick = () => { }, onBoxRemove = () => { }, onBoxAdd = () => { }, onMoveDown = () => { }, onFrameClose = () => { }, onFrameAdd = () => { }, onFrameSideFileUpload = () => { }, onDragDropFrame = () => { }, onFrameSideStatChange = () => { }, onFrameRemove = () => { }, }) => {
    const boxesDivs = [];
    ...
    for (let boxDivPosition = 0; boxDivPosition < boxes.length; boxDivPosition++) {
        ...
        boxesDivs.push(<div style="margin-bottom:15px;" onClick={(event) => {
				...
				{editable && currentBoxSelected && (<div style="height: 35px">
						<frameButtons_1.default frameSelected={frameSelected} onFrameRemove={onFrameRemove} onMoveDown={onMoveDown} onBoxRemove={onBoxRemove} onFrameAdd={onFrameAdd} showDownButton={showDownButton} box={box}/>
					</div>)}
