    ...
    return (<div style={{ padding: '20px', display: 'flex' }}>
			...
			<visualForm_1.default onSubmit={onSubmit} style="flex-grow:1">
				<div>
					...
					<input name="name" id="name" style={{ flexGrow: 1 }} autoFocus value={hive.name} onInput={onInput}/>

					<popupButton_1.PopupButtonGroup className="green">
						<button_1.default type="submit">Save</button_1.default>
						<popupButton_1.PopupButton className="green">
							{/* <InspectionButton
            apiaryId={apiaryId}
        ...
        /> */}
							...
							<deleteButton_1.default hiveId={hive.id}/>
				...
				<div>
					...
					<input name="queenYear" id="queenYear" minLength={4} maxLength={4} style={{ width: 40 }} placeholder="year" value={hive.family ? hive.family.added : ''} onInput={onQueenYearChange}/>
