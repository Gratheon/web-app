...
const boxes_2 = require("../../../storage/boxes");
const files_1 = require("../../../storage/files");
const frames_1 = require("../../../storage/frames");
const files_2 = require("../../../storage/files");
const files_3 = require("../../../storage/files");
class HiveEditForm extends preact_1.Component {
    render() {
        ...
        let [updateHive, { loadingUpdate, error, data }] = (0, api_1.useMutation)(hiveEditMutation_graphql_js_1.default);
        ...
        function onDragDropFrame({ removedIndex, addedIndex, boxIndex, apiaryId, hiveId, frameSide, }) {
            ...
            sync();
            //redirect
            if (!(0, isNil_1.default)(frameSide)) {
        ...
        return (<div>
				...
				<editFormTop_1.default hive={hive} boxes={boxes} onSubmit={onSubmit.bind(this)} onInput={(e) => setName(e.target.value)} apiaryId={apiaryId} onNotesChange={(e) => onNotesChange(e.target.value)} onRaceChange={(e) => setRace(e.target.value)} onQueenYearChange={(e) => setQueenYear(e.target.value)}/>

				<boxes_1.default apiaryId={apiaryId} hive={hive} hiveId={parseInt(hive.id, 10)} boxes={boxes} frames={frames} boxSelected={parseInt(boxSelected, 10)} frameSelected={parseInt(frameSelected, 10)} frameSide={frameSide} onDragDropFrame={onDragDropFrame} onMoveDown={onMoveDown} onBoxRemove={onBoxRemove} onBoxAdd={onBoxAdd} onBoxClick={onBoxClick} onFrameAdd={onFrameAdd} onFrameClose={onFrameClose} onFrameRemove={onFrameRemove} onFrameSideStatChange={onFrameSideStatChange} onFrameSideFileUpload={onFrameSideFileUpload}/>
			</div>);
    }
}
