...
exports.default = ({ size = 16, fill = 'gray', onClick = () => { } }) => (<svg onClick={onClick} height={size} width={size} viewBox="0 0 267.5 267.5" style="enable-background:new 0 0 267.5 267.5;">
		<path fill={fill} d="M256.975,100.34c0.041,0.736-0.013,1.485-0.198,2.229l-16.5,66c-0.832,3.325-3.812,5.663-7.238,5.681l-99,0.5
