...
const MinimizedUploadProgress = React.lazy(() => import('../shared/minimizedUploadProgress'))
...
const CanvasEditView = React.lazy(() => import('./hiveEdit/frame/canvasEditView'))
...
const WarehouseQueenDetectorPage = React.lazy(() => import('./warehouse/queenDetector'))
const WarehouseQueensCreatePage = React.lazy(() => import('./warehouse/queensCreate'))
const WarehouseBoxSystemsPage = React.lazy(() => import('./warehouse/boxSystems'))
const WarehouseBoxSystemCreatePage = React.lazy(() => import('./warehouse/boxSystemCreate'))
const WarehouseBoxSystemEditPage = React.lazy(() => import('./warehouse/boxSystemEdit'))
