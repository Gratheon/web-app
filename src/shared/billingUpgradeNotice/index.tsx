...
type BillingUpgradeNoticeProps = {
	title: ComponentChildren
	compact?: boolean
	linkText?: ComponentChildren
	linkTo?: string
}
...
export default function BillingUpgradeNotice({
	title,
	compact = false,
	linkText,
	linkTo = '/account/billing',
}: BillingUpgradeNoticeProps) {
	return (
		<div className={`${styles.card} ${compact ? styles.compact : ''}`}>
			...
			<div className={styles.textWrap}>
				...
				<NavLink className={styles.link} to={linkTo}>
					{linkText || <T>Upgrade in Billing to continue</T>}
				</NavLink>
			</div>
		</div>
	)
